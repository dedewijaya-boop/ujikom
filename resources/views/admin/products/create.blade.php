...
<<<<<<< HEAD
            <h1 class="text-xl font-semibold text-gray-900">Add New Jewelry Product</h1>
=======
            <h1 class="text-xl font-semibold text-gray-900">Tambah Produk Perhiasan Baru</h1>
>>>>>>> 4ec54b9e (update terbaru)
        </div>
    </div>
...
=======
                            <label for="nom" class="block text-sm font-medium text-gray-700">Nama Produk</label>
>>>>>>> 4ec54b9e (update terbaru)
