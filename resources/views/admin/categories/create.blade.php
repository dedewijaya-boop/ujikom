...
=======
@section('title', isset($category) ? 'Ubah Kategori' : 'Tambah Kategori')
...
=======
            <h1 class="text-xl font-semibold text-gray-900">{{ isset($category) ? 'Ubah' : 'Tambah' }} Kategori</h1>
>>>>>>> 4ec54b9e (update terbaru)
        </div>
    </div>
...
=======
                            <label for="nom" class="block text-sm font-medium text-gray-700">Nama Kategori</label>
>>>>>>> 4ec54b9e (update terbaru)
