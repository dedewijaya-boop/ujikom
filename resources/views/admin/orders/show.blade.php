...
=======
                        <h3 class="text-sm font-medium text-gray-500">Informasi Pelanggan</h3>
>>>>>>> 4ec54b9e (update terbaru)
...
=======
                        <h3 class="text-sm font-medium text-gray-500">Informasi Pengiriman</h3>
>>>>>>> 4ec54b9e (update terbaru)
                        <div class="mt-2 space-y-1">
...
=======
                                {{ $order->shipping_method ?? 'Pengiriman Standar' }}
>>>>>>> 4ec54b9e (update terbaru)
                            </p>
                        </div>
                    </div>
...
=======
                    <h2 class="text-lg font-medium">Item Pesanan</h2>
>>>>>>> 4ec54b9e (update terbaru)
                </div>
...
=======
                            <div class="mt-1 text-sm text-gray-500">SKU: {{ $item->product->sku ?? '-' }}</div>
                            <div class="mt-1 text-sm text-gray-500">Jumlah: {{ $item->quantity }}</div>
>>>>>>> 4ec54b9e (update terbaru)
...
=======
                        ...
                        <p class="mt-1 text-sm">{{ $order->created_at->translatedFormat('d M Y \\p\\u\\k\\u\\l H:i') }}</p>
                    </div>
                    @if($order->notes)
                    <div>
                        <h3 class="text-sm font-medium text-gray-500">Catatan Pelanggan</h3>
>>>>>>> 4ec54b9e (update terbaru)
...
=======
                    <h2 class="text-lg font-medium">Perbarui Status</h2>
>>>>>>> 4ec54b9e (update terbaru)
                </div>
                <div class="px-6 py-4">
