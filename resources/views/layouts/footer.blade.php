            ...
            <div class="md:col-span-2">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-gray-300 hover:text-emerald-300 transition-colors">
                        ...
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm0 2c4.41 0 8 3.59 8 8 0 4.07-3.06 7.44-7 7.93v-5.59h1.94l.31-2.01H13v-1.58c0-.82.5-1.01.77-1.01.42 0 .85.15.85.15l1.37-1.37c-.46-.43-1.06-.7-1.72-.7-1.52 0-2.75 1.23-2.75 2.75v1.38H9.38v2.01H12v5.59c-3.94-.49-7-3.86-7-7.93 0-4.41 3.59-8 8-8z" clip-rule="evenodd" />
                        </svg>
                    </a>
                </div>
            </div>
