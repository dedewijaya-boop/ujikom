    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex-shrink-0 flex items-center">
            ...
            <img src="{{ asset('images/lasvara-decor-indonesia.png') }}" class="h-10 w-auto" alt="Logo Lasvara">
             <span class="text-xl font-bold text-gray-800 ml-2">Lasvara Decor ID</span>
            </a>
        </div>

            <!-- Main Navigation (Desktop) -->
            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                <a href="{{ url('/') }}" class="{{ request()->is('/') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Selamat Datang</a>
                <a href="{{ route('about') }}" class="{{ request()->routeIs('about') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Tentang Kami</a>
                <a href="{{ route('shop') }}" class="{{ request()->routeIs('shop') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Belanja Sekarang</a>
                <a href="{{ route('orders.index') }}" class="{{ request()->routeIs('orders.*') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Pesanan Saya</a>
                <a href="{{ route('contact.show') }}" class="{{ request()->routeIs('contact.show') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Hubungi kami</a>
            </div>
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                ...
                <a href="{{ route('cart') }}" class="p-1 text-gray-400 hover:text-gray-500 relative">
                    ...
                    @if($cartCount > 0)
                        <span class="absolute -top-1 -right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-white bg-emerald-600 rounded-full">{{ $cartCount }}</span>
                    @endif
                </a>
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('register') }}" class="text-sm text-gray-700 hover:text-gray-900">Pendaftaran</a>
                        </div>
                    @endauth
                </div>
            </div>
